...
big-text/
  ...
  dobbie/                      optional: a README on Dobbie's two demos and a script that fetches them for study; nothing here uses them
...
`dobbie/fetch.sh` downloads his twelve demo files (72 MB, two of them the vertex buffers) into directories git ignores, verifying each by MD5; they are study material only, and no script or test reads them.
