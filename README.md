...
The same images for War and Peace, in `docs/shots/war-and-peace/`. The map fitted: one grid of 1,401 pages in reading order, 60 across, each page a white cell of one size in a grey gutter, a chapter's last page short.
